...
class SurveiPg3Widget extends StatefulWidget {
  const SurveiPg3Widget({Key? key}) : super(key: key);

  @override
  _SurveiPg3WidgetState createState() => _SurveiPg3WidgetState();
}

class _SurveiPg3WidgetState extends State<SurveiPg3Widget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Survei_pg3'});
  }
