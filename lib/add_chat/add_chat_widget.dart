...
class _AddChatWidgetState extends State<AddChatWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'addChat'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('ADD_CHAT_arrow_back_rounded_ICN_ON_TAP');
          ...
          Container(
            ...
            child: Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('ADD_CHAT_PAGE_INVITE_TO_CHAT_BTN_ON_TAP');
                  logFirebaseEvent('Button_group_chat_action');
                  addChat = await FFChatManager.instance.addGroupMembers(
                    widget.chat!,
