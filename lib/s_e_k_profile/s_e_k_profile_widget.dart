...
class SEKProfileWidget extends StatefulWidget {
  const SEKProfileWidget({Key? key}) : super(key: key);

  @override
  _SEKProfileWidgetState createState() => _SEKProfileWidgetState();
}

class _SEKProfileWidgetState extends State<SEKProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'SEK_Profile'});
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'S_E_K_PROFILE_CircleImage_w8ldx8k9_ON_TA');
