...
class WRTProfileWidget extends StatefulWidget {
  const WRTProfileWidget({Key? key}) : super(key: key);

  @override
  _WRTProfileWidgetState createState() => _WRTProfileWidgetState();
}

class _WRTProfileWidgetState extends State<WRTProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'WRT_Profile'});
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'W_R_T_PROFILE_CircleImage_le8nrr9h_ON_TA');
