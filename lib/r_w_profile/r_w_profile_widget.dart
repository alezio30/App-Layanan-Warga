...
class RWProfileWidget extends StatefulWidget {
  const RWProfileWidget({Key? key}) : super(key: key);

  @override
  _RWProfileWidgetState createState() => _RWProfileWidgetState();
}

class _RWProfileWidgetState extends State<RWProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'RW_Profile'});
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'R_W_PROFILE_CircleImage_bb9o20h1_ON_TAP');
