...
class WRWProfileWidget extends StatefulWidget {
  const WRWProfileWidget({Key? key}) : super(key: key);

  @override
  _WRWProfileWidgetState createState() => _WRWProfileWidgetState();
}

class _WRWProfileWidgetState extends State<WRWProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'WRW_Profile'});
              ...
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      logFirebaseEvent(
                          'W_R_W_PROFILE_CircleImage_gdo3tjvi_ON_TA');
